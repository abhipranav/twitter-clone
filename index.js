...
const savedTweetsData = loadTweetsFromLocalStorage()
if(savedTweetsData) {
    tweetsData.length = 0 //clear the array
...
function loadTweetsFromLocalStorage() {
    ...
    return savedTweets ? JSON.parse(savedTweets) : null
}

//Function to resetData
function resetData() {
